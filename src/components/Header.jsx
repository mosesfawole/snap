    ...
    <div className="md:p-4">
      ...
      <div className="menu-items hidden  md:flex p-4 justify-between items-center">
        <div className="menu-left flex gap-4 items-center  ">
          {/* Logo */}
          <div className="logo mr-2 cursor-pointer">
        ...
        <div className="right flex text-sm ">
          <div className="buttons flex gap-8 justify-between">
            <button>Login</button>
            <button className="py-2 px-6 rounded-2xl border-2 border-gray-400">
              Register
            </button>
          </div>
        </div>
